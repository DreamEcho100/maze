...
const UserInput = () => {
	...
	const setQuestions = useStore(deepResearchStore, (state) => state.setQuestions);
	...
	return (
		<Form {...form}>
			...
			>
				...
				/>
				<Button type="submit" className="cursor-pointer rounded-full px-6" disabled={isLoading}>
					{isLoading ? (
						<>
