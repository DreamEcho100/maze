...
export const bytea = /** @type {typeof customType<{ data: Uint8Array<ArrayBufferLike>; notNull: false; default: false }>} */(customType)({
	dataType() {
		return "bytea";
	},
	toDriver(val) {
    ...
    return /** @type {Uint8Array<ArrayBufferLike>} */(new Uint8Array(
      val.buffer,
      val.byteOffset,
      val.byteLength,
    ));
