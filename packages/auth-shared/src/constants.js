...
export const ACCESS_TOKEN_EXPIRES_DURATION = 15 * 60 * 1000; // 15 minutes
export const REFRESH_TOKEN_EXPIRES_DURATION = 30 * 24 * 60 * 60 * 1000; // 30 days

export const AUTHENTICATION_REQUIRED = /** @type {const} */ ({
	type: "error",
	statusCode: 401,
