...
import { userIdFkCol, userIdFkExtraConfig } from "../2-user/0_utils/index.js";
import { orgIdFkCol, orgIdFkExtraConfig } from "../3-org/0_utils/index.js";
import {
	orgMemberIdFkCol,
...
} from "../3-org/1-member-and-employee/employee/0_utils/index.js";

const accountTableName = "account";

export const accountingLedgerAccountTypeEnum = tEnum(`${accountTableName}_type`, [
...
export const accountingLedgerNormalBalanceTypeEnum = tEnum(`${accountTableName}_balance_type`, [
...
export const account = table(
	accountTableName,
	{
		...
		type: accountingLedgerAccountTypeEnum("type").notNull(), // e.g. 'asset', 'liability', 'equity', 'revenue', 'expense'

		// Balance tracking
		currentBalance: numericCols.currency.amount("current_balance").default("0.00"),
		normalBalance: accountingLedgerNormalBalanceTypeEnum("normal_balance").notNull(), // e.g. 'debit', 'credit'
...
// export const accountTransactionReferenceTypeEnum = tEnum(
...
export const accountTransactionBusinessEntityTypeEnum = tEnum(
...
export const accountTransactionContextTypeEnum = tEnum(
	`${accountTransactionContextTableName}_type`,
	["primary", "secondary", "derived", "administrative"],
);
export const accountTransactionContextRelationshipTypeEnum = tEnum(
