...
import { orgMemberIdFkCol, orgMemberIdFkExtraConfig } from "../0_utils/index.js";
import { orgMemberBaseRoleEnum } from "../00-schema.js";

const orgMemberInvitationTableName = `${orgMemberTableName}_invitation`;
export const orgMemberInvitationStatusEnum = tEnum(`${orgMemberInvitationTableName}_status`, [
...
export const invitationTypeEnum = tEnum(`${orgMemberInvitationTableName}_type`, [
	"learner",
	"customer",
	"community_member",
]);
