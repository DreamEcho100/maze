...
import { userJobProfileIdFkCol } from "../../../schema.js";
...
export const orgEmployeeRoleEnum = tEnum(`${orgEmployeeTableName}_base_role`, [
...
export const orgEmployeeStatusEnum = tEnum(`${orgEmployeeTableName}_status`, [
