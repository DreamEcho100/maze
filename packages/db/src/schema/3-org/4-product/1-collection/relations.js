...
import { orgDiscountProductCollection } from "../../5-offers/schema.js";
 ...
 */
export const orgProductCollectionRelations = relations(orgProductCollection, ({ one, many }) => ({
	/**
 ...
 */
export const orgProductCollectionProductRelations = relations(
