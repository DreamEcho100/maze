 ...
 */
export const userJobProfileRelations = relations(
	userJobProfile,
	({ one, many }) => ({
...
export const userJobProfileSkillRelations = relations(
	userJobProfileSkill,
	({ one }) => ({
...
export const userJobProfileMetricsRelations = relations(
	userJobProfileMetrics,
	({ one }) => ({
		/**
