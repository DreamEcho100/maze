...
export const dateInput = {
	...
	parse: (type) => {
		 ...
		 */
		return (dateString) =>
			!dateString ? null : inputDateHelpers.parseDate(dateString, type);
	},
	/**
	 * @param {import("..").InputDateTypes} type
	...
	format: (type) => {
		 ...
		 */
		return (dateString) =>
			!dateString ? null : inputDateHelpers.formatDate(dateString, type);
	},
};
...
export const onNullable = {
	...
	falsy: {
		 ...
		 * @param {Value} value
		 */
		toUndefined: (value) => onNotNullableTo(undefined)(value),
		/**
		 * @template Value
		 * @param {Value} value
		 */
		toNull: (value) => onNotNullableTo(null)(value),
		/**
		 * @template DefaultValue
		 * @param {DefaultValue} defaultValue
		 */
