...
resolver.pathToNode["addresses.@@__FIELD_TOKEN_ARRAY_ITEM__@@.street"] // Array item street config
```
...
- **`@@__FIELD_TOKEN_ARRAY_ITEM__@@`** - Represents any array item
- **`@@__FIELD_TOKEN_RECORD_PROPERTY__@@`** - Represents any record property  
- **`@@__FIELD_TOKEN_UNION_OPTION_ON__@@`** - Represents union option branches
