...
type NormalizedPathStringSegment<
	Segment extends PathSegmentItem | never,
	...
	: Segment extends FieldNodeConfigTokenEnum["recordProperty"]
		...
		: Segment extends number
			...
			: Segment extends never
				? {
						normalizedPathString: PathSegmentsToString<NormalizedPathSegments>;
						normalizedPathSegments: NormalizedPathSegments;
					}
				: {
						normalizedPathString: PathSegmentsToString<
...
export type DeepFieldNodePath<
	...
	NormalizedPathSegments extends PathSegmentItem[] = [],
> = {
	[K in keyof ParentNode]: K extends FnConfigKey
		? {
				pathString: Path;
		...
		: // & NormalizedPathStringSegment<
			...
			DeepFieldNodePath<
				ParentNode[K],
				JoinPath<Path, K & PathSegmentItem>,
				[...PathSegments, K & PathSegmentItem],
				NormalizedPathStringSegment<
					K & PathSegmentItem,
					PathSegments,
					ParentNode,
