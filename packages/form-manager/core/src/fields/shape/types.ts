import { fnConfigKey, fnIOValueToInfer } from "#constants.js";
import type {
	AnyRecord,
...
export type FieldNode<
	...
	OutputValue = InputValue,
	Config extends FieldNodeConfig = FieldNodeConfig,
	T = Record<PathSegmentItem, InternalFieldNode<any, any, any, any>>,
> = {
	[Key in keyof T]: T extends FnConfigKey ? Config : T[Key];
} & {
	[fnIOValueToInfer]?: {
		$input: InputValue;
		$output: OutputValue;
...
> = T & {
	...
	[Key in PathSegmentItem]: Key extends FnConfigKey ? Config : FieldNode;
};
