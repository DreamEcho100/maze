...
export const productInstructorAttributionRelations = relations(
	...
	({ one }) => ({
		...
		/**
		 * @organizationContext Organization context for professional attribution
...
export const productBrandAttributionRelations = relations(
	...
	({ one }) => ({
		/**
		 * @brandIdentity Organization brand this attribution applies to
 ...
 */
export const discountVariantRelations = relations(
	discountVariant,
	({ one }) => ({
		/**
