	...
	(cols) => [
		...
		...multiIndexes({
			...
			colsGrps: [
				...
				{ cols: [cols.migrationTarget] }, // Migration tracking
			],
		}),
	],
);
...
export const orgCategory = table(
	orgCategoryTableName,
	{
		...
		scope: orgCategoryScopeEnum("type").notNull(),
		/** Creation timestamp */
		createdAt: temporalCols.audit.createdAt().notNull(),
	...
	(cols) => [
		...
		...multiIndexes({
			...
			colsGrps: [
				...
				{ cols: [cols.slugRef] }, // Cross-org category analysis
...
export const orgCategoryAssociation = table(
	orgCategoryAssociationTableName,
	{
		...
		relationshipType: relationshipTypeEnum("type").default("hierarchical"),
	...
	(cols) => [
		...
		...multiIndexes({
			tName: orgCategoryAssociationTableName,
			colsGrps: [
				{ cols: [cols.orgId, cols.parentSlugRef, cols.scope] }, // Find children
				{ cols: [cols.orgId, cols.childSlugRef, cols.scope] }, // Find parents
...
export const userCategory = table(
	userCategoryTableName,
	{
		...
		scope: userCategoryScopeEnum("type").notNull(),
		/** Creation timestamp */
		createdAt: temporalCols.audit.createdAt().notNull(),
		/** Last modification timestamp */
		lastUpdatedAt: temporalCols.audit.lastUpdatedAt().notNull(),
	...
	(cols) => [
		...
		...multiIndexes({
			...
			colsGrps: [
				...
				{ cols: [cols.slugRef] }, // Cross-user category analysis
				{ cols: [cols.createdAt] }, // Timeline queries
				{ cols: [cols.lastUpdatedAt] }, // Change tracking
			],
		}),
